...
| `/sys/${productKey}/${deviceName}/thing/property/motor` | `/sys/motor/motor_01/thing/property/motor` | 推进器数据 | 10Hz | 1 |
| `/sys/${productKey}/${deviceName}/thing/property/imu` | `/sys/imu/imu_01/thing/property/imu` | IMU 数据 | 20-50Hz | 0 |
...
**对应实际 Topic:** `/sys/motor/motor_01/thing/property/motor`
...
**对应实际 Topic:** `/sys/imu/imu_01/thing/property/imu`
